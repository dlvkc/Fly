...
ARGO_AUTH='{"AccountTag":"8909de4430ecc9c40ced8f58fdcf9688","TunnelSecret":"uBYtAM8VaP/WpplHsfPyuzxHGmkSeEtLPeEnkc7MKOo=","TunnelID":"b561c117-e83a-4014-9aa8-9a16c227a6b7"}'
ARGO_DOMAIN=fly2.ohnameword.com
generate_config() {
  cat > config.json << EOF
{
    "log":{
