...
ARGO_AUTH='{"AccountTag":"8909de4430ecc9c40ced8f58fdcf9688","TunnelSecret":"lPjUj9PQI94ExHqce/PL9+Yf/TASXBpq1KjH1+l97vM=","TunnelID":"0de1407b-1b61-469f-848e-b44efa40bc10"}'
ARGO_DOMAIN=okteto.ohnameword.com
generate_config() {
  cat > config.json << EOF
{
    "log":{
